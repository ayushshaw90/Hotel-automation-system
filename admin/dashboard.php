...
<body>
  <div class="databox">
    <div class="box roombookbox room-book">
      <img src="../image/icon/room.png" alt="R" width="32px">
      <h1><?php echo $roombookrow ?> / <?php echo $roomrow ?></h1>
      <h3>Total Booked Room</h3>
    </div>
    <div class="box guestbox total-staff">
    <img src="../image/icon/employee.png" alt="R" width="32px">
      <h1><?php echo $staffrow ?></h1>
      <h3>Total Staff</h3>
    </div>
    <div class="box profitbox total-revenue">
    <img src="../image/icon/money-bag.png" alt="R" width="32px">
  ...
  <div class="chartbox">
    ...
    <div class="profitchart">
      ...
      <h3 style="text-align: center;margin:10px 0;">Revenue</h3>
    </div>
  </div>
</body>
